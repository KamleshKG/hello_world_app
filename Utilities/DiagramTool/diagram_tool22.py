...
class DiagramApp:
    ...
    def _draw_arrow(self,arrow):
        ...
        if not in_focus_arrow and self._focus_ids:
            ...
            c.create_line(cx1,cy1,cx2,cy2,fill="#2a2a4a",width=1,dash=dash_dim)
            return
    ...
    def _draw_floattext(self,ft):
        ...
        col=SEL_COL if is_sel else (ACCENT2 if not self._focus_ids else "#333355")
